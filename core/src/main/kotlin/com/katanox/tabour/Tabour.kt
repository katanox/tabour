...
internal const val TABOUR_SHUTDOWN_MESSAGE = "tabour shutdown"

/**
 * After registering all registries, the tabour container can be started using [start]. To stop the
 * consumption of the container, you can use [stop] By default, the container will allocate 4
 * threads which can be configured using [Configuration]
 *
...
class Tabour internal constructor(val config: Configuration) {
     ...
     *
     * @param registryKey the key of the registry which the producer is part of
     * @param producerKey the key of the producer itself
     * @param productionConfiguration The object that provides the handlers to
     * - produce data
    ...
    /** Indicates if tabour has started consuming messages */
