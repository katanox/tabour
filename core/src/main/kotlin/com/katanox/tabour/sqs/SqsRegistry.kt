...
internal constructor(
  ...
  fun addConsumers(consumers: List<SqsConsumer>): SqsRegistry<T> =
      this.apply {
        consumers.fold(this) { registry, consumer -> registry.apply { this.addConsumer(consumer) } }
      }
  ...
  fun <K> addProducers(producers: List<SqsProducer<K>>): SqsRegistry<T> =
      this.apply {
        producers.fold(this) { registry, producer -> registry.apply { this.addProducer(producer) } }
      }
